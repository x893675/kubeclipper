...
func (m *MockOperator) ListLeases(ctx context.Context, namespace string, query *query.Query) (*v1.LeaseList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListLeases", ctx, namespace, query)
...
func (mr *MockOperatorMockRecorder) ListLeases(ctx, namespace, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListLeases", reflect.TypeOf((*MockOperator)(nil).ListLeases), ctx, namespace, query)
}

// WatchLease mocks base method
func (m *MockOperator) WatchLease(ctx context.Context, namespace string, query *query.Query) (watch.Interface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WatchLease", ctx, namespace, query)
...
func (mr *MockOperatorMockRecorder) WatchLease(ctx, namespace, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WatchLease", reflect.TypeOf((*MockOperator)(nil).WatchLease), ctx, namespace, query)
}
...
// ListLeases mocks base method
func (m *MockLeaseReader) ListLeases(ctx context.Context, namespace string, query *query.Query) (*v1.LeaseList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListLeases", ctx, namespace, query)
	ret0, _ := ret[0].(*v1.LeaseList)
	ret1, _ := ret[1].(error)
...
// ListLeases indicates an expected call of ListLeases
func (mr *MockLeaseReaderMockRecorder) ListLeases(ctx, namespace, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListLeases", reflect.TypeOf((*MockLeaseReader)(nil).ListLeases), ctx, namespace, query)
}

// WatchLease mocks base method
func (m *MockLeaseReader) WatchLease(ctx context.Context, namespace string, query *query.Query) (watch.Interface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WatchLease", ctx, namespace, query)
	ret0, _ := ret[0].(watch.Interface)
	ret1, _ := ret[1].(error)
...
// WatchLease indicates an expected call of WatchLease
func (mr *MockLeaseReaderMockRecorder) WatchLease(ctx, namespace, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WatchLease", reflect.TypeOf((*MockLeaseReader)(nil).WatchLease), ctx, namespace, query)
}
